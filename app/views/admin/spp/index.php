<div class="container-fluid">
    ...
    <button class="btn btn-success my-2 col" data-toggle="modal" data-target="#adminSppModal" id="adminTambahSppBtn">Tambah SPP Baru</button>
</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="adminSppModalLabel">Tambah SPP Baru</h5>
