<div class="container-fluid">
    ...
    <div class="card shadow border-0 mb-4">
        <div class="card-header">
            <h6 class="font-weight-bold text-warning m-0">Profile</h6>
        </div>
        <div class="card-body py-3">
            ...
            <div class="form-row">
                ...
                <div class="col-md-7">
                    ...
                    <h6 class="text-danger font-weight-bold">Reset Password</h6>
                    ...
                    <input type="hidden" name="id_pengguna" value="<?=$data['petugas']['id_pengguna']?>">
                        ...
                        <button type="button" class="btn btn-block btn-danger" data-toggle="modal" data-target="#adminResetPasswordModal">Reset Password</button>
                    </form>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-header">
            <h5 class="modal-title font-weight-bold" id="adminResetPasswordModalLabel">Yakin untuk reset password?</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            Aksi anda tidak akan dapat dikembalikan!
        </div>
