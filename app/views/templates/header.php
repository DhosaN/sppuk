    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SPPUK</div>
            </a>
            <span class="justify-content-center text-center h6 mb-0 font-weight-bold text-warning">(Spp Uji Kompetensi)</span>
            ...
            <li class="nav-item <?=$data['heading']=='manajemen kelas' ? 'active' : ''?>">
                ...
                <div id="manajemenKelasCollapse" class="collapse <?=$data['options']=='daftar kelas' ? 'show' : ''?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelas: </h6>
                        <a class="collapse-item <?=$data['options']=='daftar kelas' ? 'active' : ''?>" href="<?=BASE_URL?>/petugas-kelas">Daftar Kelas</a>
                    </div>
                </div>
            </li>
